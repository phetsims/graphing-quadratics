    ...
    "PropertyIO.<NullableIO.<QuadraticIO>>": {
      ...
      "methods": {
        ...
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": {
            "0": "FunctionIO.<NullableIO.<QuadraticIO>, NullableIO.<NullableIO.<QuadraticIO>>>"
          },
          "returnType": "VoidIO"
        },
        "link": {
        ...
        "unlink": {
          "documentation": "Removes a listener.",
          "parameterTypes": {
            "0": "FunctionIO.<NullableIO.<QuadraticIO>>"
          },
          "returnType": "VoidIO"
        }
      },
    ...
    "PropertyIO.<Vector2IO>": {
      ...
      "methods": {
        ...
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": {
            "0": "FunctionIO.<Vector2IO, NullableIO.<Vector2IO>>"
          },
          "returnType": "VoidIO"
        },
        "link": {
