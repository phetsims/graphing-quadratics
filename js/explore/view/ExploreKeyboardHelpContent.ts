...
/**
 * ExploreKeyboardHelpContent is the content for the keyboard-help dialog in the 'Explore' screen.
 *
...
graphingQuadratics.register( 'ExploreKeyboardHelpContent', ExploreKeyboardHelpContent );