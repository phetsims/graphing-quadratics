# Graphing Quadratics - Release Notes
<!-- 
Instructions:
...
* Point tools: Negative coordinates are now displayed correctly for right-to-left (RTL) languages. For example, `-1` instead of `1-`.
